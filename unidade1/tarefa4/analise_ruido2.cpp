...
void filtro_media_harmonca(const Mat src, Mat &dest, uint32_t m, uint32_t n);
//Filtros com 3 parametros: m,n, x
//para q: ordem do filtro
void filtro_media_contra_harmonca(const Mat src, Mat &dest, uint32_t m, uint32_t n, uint32_t q);
